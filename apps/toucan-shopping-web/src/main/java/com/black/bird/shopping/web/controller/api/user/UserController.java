package com.toucan.shopping.web.controller.api.user;
...
public class UserController extends BaseController {
    ...
    public ResultObjectVO sendRegistVerifyCode(String mobilePhone)
    {
        ...
        try {
            ...
            userSmsVO.setMsg("[黑鸟电商]您于"+DateUtils.format(DateUtils.currentDate(), DateUtils.FORMATTER_DD_CN)+"申请了手机号码注册,验证码是"+code);
