...
public class FreeShopGeneratorController extends UIController {
    ...
    @RequestMapping(value = "/freeShopGeneratorPage",method = RequestMethod.GET)
    ...
    {
        String previewApi = "/api/html/freeShop/generate/preview";
    ...
    {
        String previewApi = "/api/html/freeShop/generate/release";
