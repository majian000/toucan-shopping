...
@Controller
public class IndexGeneratorPageController extends UIController {
    ...
    @RequestMapping(value = "/htmlPage/indexGenerator/indexGeneratorPage",method = RequestMethod.GET)
