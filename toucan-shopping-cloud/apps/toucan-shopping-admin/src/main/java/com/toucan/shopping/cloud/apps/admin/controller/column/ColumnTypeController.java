...
//                    List<MessageTypeVO> columnTypeVOS = JSONArray.parseArray(JSONObject.toJSONString(resultObjectVO.getData()),MessageTypeVO.class);
...
//                return resultObjectVO;
//            }
//            MessageTypeVO columnTypeVO =new MessageTypeVO();
