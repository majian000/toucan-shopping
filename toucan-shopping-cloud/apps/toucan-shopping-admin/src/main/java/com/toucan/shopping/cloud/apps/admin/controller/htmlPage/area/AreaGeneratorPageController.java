...
@Controller
public class AreaGeneratorPageController extends UIController {
    ...
    @RequestMapping(value = "/htmlPage/areaGenerator/areaGeneratorPage",method = RequestMethod.GET)
    public String indexGeneratorPage(HttpServletRequest request)
    {
        ...
        //初始化最终文件选项卡里的按钮
        this.initButtons(request,"releaseTabButtons","/area/html/generate/release");


        return "pages/htmlPage/area/area.html";
    }
