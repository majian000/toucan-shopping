...
public class FreightTemplateController {
    ...
    public TableVO list(HttpServletRequest httpServletRequest, FreightTemplatePageInfo pageInfo) {
        ...
        try {
            ...
            ResultObjectVO resultObjectVO = freightTemplateService.queryListPage(requestJsonVO);
    ...
    public ResultObjectVO deleteById(HttpServletRequest request, @RequestBody FreightTemplateVO freightTemplateVO) {
        ...
        try {
            Long id = freightTemplateVO.getId();
            ...
            if (resultObjectVO.isSuccess()) {
                ...
                resultObjectVO = freightTemplateService.deleteById(FreightTemplateUtils.getDeleteSignHeader(String.valueOf(freightTemplateRetVO.getUserMainId())), requestJsonVO);
            }
        } catch (Exception e) {
            resultObjectVO.setCode(ResultObjectVO.FAILD);
