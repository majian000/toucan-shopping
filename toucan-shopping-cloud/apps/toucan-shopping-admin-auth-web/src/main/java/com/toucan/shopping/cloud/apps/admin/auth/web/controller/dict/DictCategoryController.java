...
public class DictCategoryController extends UIController {
    ...
    @ResponseBody
    public TableVO list(HttpServletRequest request, @RequestBody(required = false) DictCategoryPageInfo pageInfo)
    {
        TableVO tableVO = new TableVO();
        try {
            if (pageInfo == null) {
                pageInfo = new DictCategoryPageInfo();
            }
     ...
     * @return
     */
    @AdminAuth(verifyMethod = AdminAuth.VERIFYMETHOD_ADMIN_AUTH, verifyType = AdminAuth.VERIFY_TYPE_ANY, permissions = {"pms:dict:category:view"})
