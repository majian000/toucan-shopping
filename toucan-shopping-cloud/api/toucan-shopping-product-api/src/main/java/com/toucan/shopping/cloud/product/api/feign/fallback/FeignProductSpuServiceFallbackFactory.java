    ...
    public FeignProductSpuService create(Throwable throwable) {
        ...
        return new FeignProductSpuService(){
            ...
            public ResultObjectVO update(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignProductSpuService update faild params:"+JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败,请重试!");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO deleteByIds(RequestJsonVO requestVo) {
                ...
                logger.warn("FeignProductSpuService deleteByIds faild params {} ",requestVo.getEntityJson());
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败,请重试!");
                return resultObjectVO;
            }
