 ...
 */
@Component
public class FeignAttributeValueServiceFallbackFactory implements FallbackFactory<FeignAttributeValueService> {

    private final Logger logger = LoggerFactory.getLogger(getClass());

    @Override
    public FeignAttributeValueService create(Throwable throwable) {
        logger.warn(throwable.getMessage(),throwable);
        return new FeignAttributeValueService(){
            @Override
