    ...
    public FeignShopProductApproveService create(Throwable throwable) {
        ...
        return new FeignShopProductApproveService(){
            ...
            public ResultObjectVO deleteByProductApproveIdAndShopId(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignShopProductApproveService deleteByProductApproveIdAndShopId faild  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO queryNewestListByShopId(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignShopProductApproveService queryNewestListByShopId faild  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO findOneUnderReviewByFreightTemplateId(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignShopProductApproveService findOneUnderReviewByFreightTemplateId faild  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO queryApproveListByShopId(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignShopProductApproveService queryApproveListByShopId faild  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
            ...
            public ResultTypeObjectVO<Long> queryApproveCountByShopId(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignShopProductApproveService queryApproveCountByShopId faild  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
