package com.toucan.shopping.cloud.seller.api.cloud.feign.fallback;

import com.alibaba.fastjson.JSONObject;
import com.toucan.shopping.cloud.seller.api.cloud.feign.service.FeignSellerShopService;
    ...
    public FeignSellerShopService create(Throwable throwable) {
        ...
        return new FeignSellerShopService(){
            ...
            public ResultObjectVO findByIdList(RequestJsonVO requestVo) {
                ...
                logger.warn("FeignSellerShopService.findByIdList 失败   params{}",JSONObject.toJSONString(requestVo));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO flushCache(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignSellerShopService.flushCache 失败  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
