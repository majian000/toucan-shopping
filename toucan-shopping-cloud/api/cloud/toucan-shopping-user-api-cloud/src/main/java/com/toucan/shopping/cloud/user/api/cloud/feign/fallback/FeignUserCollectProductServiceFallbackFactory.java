...
import com.toucan.shopping.cloud.user.api.cloud.feign.service.FeignUserCollectProductService;
    ...
    public FeignUserCollectProductService create(Throwable throwable) {
        ...
        return new FeignUserCollectProductService(){
            ...
            public ResultObjectVO deleteById(RequestJsonVO requestVo) {
                ...
                logger.warn("调用FeignUserCollectProductService.deleteById 失败  params{}",JSONObject.toJSONString(requestVo));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求超时,请稍后重试");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO deleteByIds(RequestJsonVO requestVo) {
                ...
                logger.warn("调用FeignUserCollectProductService.deleteByIds 失败  params{}",JSONObject.toJSONString(requestVo));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求超时,请稍后重试");
                return resultObjectVO;
            }
