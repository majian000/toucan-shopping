package com.toucan.shopping.cloud.stock.api.cloud.feign.fallback;
    ...
    public FeignProductSkuStockLockService create(Throwable throwable) {
        ...
        return new FeignProductSkuStockLockService(){
            ...
            public ResultObjectVO findLockStockNumByOrderNo(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignProductSkuStockLockService.findLockStockNumByOrderNo  params {}", JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("查询锁定失败,请重试!");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO deleteLockStockByOrderNo(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignProductSkuStockLockService.deleteLockStockByOrderNo  params {}", JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("查询锁定失败,请重试!");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO findLockStockListByMainOrderNos(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignProductSkuStockLockService.findLockStockListByMainOrderNos  params {}", JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("查询锁定失败,请重试!");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO findById(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignProductSkuStockLockService.findById  params {}", JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("查询锁定失败,请重试!");
                return resultObjectVO;
            }
