...
import com.toucan.shopping.cloud.admin.auth.api.cloud.feign.fallback.FeignDictCategoryServiceFallbackFactory;
...
@FeignClient(value = "toucan-shopping-gateway",path = "/toucan-shopping-admin-auth-proxy/dictCategory",fallbackFactory = FeignDictCategoryServiceFallbackFactory.class)
public interface FeignDictCategoryService extends DictCategoryServiceAPI {
