...
import com.toucan.shopping.cloud.admin.auth.api.FeignRoleFunctionService;
import com.toucan.shopping.cloud.admin.auth.api.FeignRoleService;
    ...
    public FeignRoleFunctionService create(Throwable throwable) {
        ...
        return new FeignRoleFunctionService(){
            ...
            public ResultObjectVO queryFunctionTreeByRoleIdAndParentId(RequestJsonVO requestVo) {
                ...
                logger.warn("FeignRoleFunctionService.queryFunctionTreeByRoleIdAndParentId faild  params {}",JSONObject.toJSONString(requestVo));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请稍后重试!");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO refreshCache(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignRoleFunctionService.refreshCache faild  params {}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请稍后重试!");
                return resultObjectVO;
            }
