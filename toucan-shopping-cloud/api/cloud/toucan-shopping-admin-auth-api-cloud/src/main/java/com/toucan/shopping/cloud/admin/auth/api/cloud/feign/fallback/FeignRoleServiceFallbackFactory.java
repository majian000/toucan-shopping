    ...
    public FeignRoleService create(Throwable throwable) {
        ...
        return new FeignRoleService(){
            ...
            public ResultObjectVO queryDetail(RequestJsonVO requestVo) {
                ...
                logger.warn("FeignRoleService.queryDetail faild params:"+ JSONObject.toJSONString(requestVo));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请稍后重试!");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO queryRoleFunctionListPage(RequestJsonVO requestVo) {
                ...
                logger.warn("FeignRoleService.queryRoleFunctionListPage faild params:"+ JSONObject.toJSONString(requestVo));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请稍后重试!");
                return resultObjectVO;
            }
