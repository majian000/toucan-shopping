...
import com.toucan.shopping.cloud.admin.auth.api.cloud.feign.service.FeignDictService;
    ...
    public FeignDictService create(Throwable throwable) {
        ...
        return new FeignDictService(){
            ...
            public ResultObjectVO queryTreeAll(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignDictService.queryTreeAll failed params:"+ JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请稍后重试!");
                return resultObjectVO;
            }
