...
import com.toucan.shopping.cloud.admin.auth.api.cloud.feign.fallback.FeignOperateServiceFallbackFactory;
...
public interface FeignOperateLogService extends OperateLogServiceAPI {
