package com.toucan.shopping.cloud.message.api.cloud.feign.fallback;
    ...
    public FeignMessageUserService create(Throwable throwable) {
        ...
        return new FeignMessageUserService(){
            ...
            public ResultObjectVO deleteById(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("调用FeignMessageService.deleteById失败  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求超时,请稍后重试");
                return resultObjectVO;
            }
