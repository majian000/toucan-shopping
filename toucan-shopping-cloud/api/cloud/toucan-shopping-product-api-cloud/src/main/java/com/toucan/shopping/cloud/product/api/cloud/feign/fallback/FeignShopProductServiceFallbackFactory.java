 ...
 */
@Component
public class FeignShopProductServiceFallbackFactory implements FallbackFactory<FeignShopProductService> {
    ...
    public FeignShopProductService create(Throwable throwable) {
        ...
        return new FeignShopProductService(){
            ...
            public ResultObjectVO queryList(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignShopProductService queryList faild  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO shelves(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignShopProductService shelves faild  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
            ...
            public ResultObjectVO updateFreightTemplate(RequestJsonVO requestJsonVO) {
                ...
                logger.warn("FeignShopProductService updateFreightTemplate faild  params{}",JSONObject.toJSONString(requestJsonVO));
                resultObjectVO.setCode(ResultObjectVO.FAILD);
                resultObjectVO.setMsg("请求失败");
                return resultObjectVO;
            }
