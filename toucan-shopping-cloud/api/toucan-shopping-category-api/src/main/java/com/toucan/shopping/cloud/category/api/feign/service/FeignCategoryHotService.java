...
import com.toucan.shopping.cloud.category.api.feign.fallback.FeignCategoryHotServiceFallbackFactory;
...
@FeignClient(value = "toucan-shopping-gateway",path = "/toucan-shopping-category-proxy/category/hot",fallbackFactory = FeignCategoryHotServiceFallbackFactory.class)
public interface FeignCategoryHotService {
