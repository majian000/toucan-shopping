...
public class AttributeKeyValueController {
    ...
    private SimplePropertyPreFilter attributeKeyPropertyFilter =  new SimplePropertyPreFilter(AttributeKeyVO.class, "id","attributeName","parentId","children","sort","values");
