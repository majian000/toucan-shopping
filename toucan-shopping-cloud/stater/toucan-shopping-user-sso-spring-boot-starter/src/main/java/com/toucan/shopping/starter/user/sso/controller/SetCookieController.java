...
public class SetCookieController {
    ...
    public void setCookie(String domain,String cookies, HttpServletResponse response)
    {
        ...
        response.addHeader("Set-Cookie","tss_uid="+tss_uid+"; Max-Age=2147483647;SameSite=None; Domain=localhost; Path=/");
        response.addHeader("Set-Cookie","tss_lt="+tss_lt+"; Max-Age=2147483647; SameSite=None; Domain=localhost; Path=/");
