...
#### 阿里云ECS linux 64位 CPU单核/内存2G
    ...
    ====================基础服务层======================================
    配置中心
    启动:nohup java  -Xmx15m  -jar toucan-shopping-cloud-config-server-1.0-SNAPSHOT.jar  &
    说明:设置最大可用堆内存
    
    服务中心
    启动:nohup java -Xmx50m   -jar toucan-shopping-eureka-1.0-SNAPSHOT.jar --spring.profiles.active=prod  &
    说明:设置最大可用堆内存
    
    网关服务
    启动:nohup java   -Xmx30m   -jar toucan-shopping-gateway-1.0-SNAPSHOT.jar --spring.profiles.active=prod  &
    说明:设置最大可用堆内存
    ...
    ======================服务层===========================================
    用户服务
    启动:nohup java  -Xmx500m   -jar toucan-shopping-user-1.0-SNAPSHOT.jar --spring.profiles.active=prod  &
    说明:设置最大可用堆内存
    
    类别服务
    启动:nohup java  -Xmx50m    -jar toucan-shopping-category-1.0-SNAPSHOT.jar --spring.profiles.active=prod  &
    说明:设置最大可用堆内存
    ...
    权限服务
    启动:nohup java  -Xmx100m  -jar toucan-shopping-admin-auth-1.0-SNAPSHOT.jar --spring.profiles.active=prod  &
    说明:设置最大可用堆内存
