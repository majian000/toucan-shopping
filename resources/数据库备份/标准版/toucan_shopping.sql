/*
 ...
 Source Schema         : toucan_shopping

 Target Server Type    : MySQL
 Target Server Version : 80018
 File Encoding         : 65001

 Date: 14/04/2021 16:11:28
*/
...
CREATE TABLE `t_area`  (
  ...
  `area_sort` bigint(20) UNSIGNED NULL DEFAULT 0 COMMENT '排序',
  `is_municipality` smallint(6) NULL DEFAULT NULL COMMENT '是否直辖市 0:否 1:是',
  `type` smallint(5) UNSIGNED NULL DEFAULT 0 COMMENT '1省 2市 3区县',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7258 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '地区编码表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_attribute_key`  (
  ...
  `attribute_sort` bigint(20) NULL DEFAULT NULL COMMENT '排序',
  `app_code` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '所属应用',
  `delete_status` tinyint(4) NULL DEFAULT 0 COMMENT '删除状态 0未删除 1已删除',
  `create_date` datetime(6) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `t_banner`  (
  ...
  `position` smallint(6) NULL DEFAULT NULL COMMENT '类型 0:首页顶部 1:栏目左侧',
  `banner_sort` bigint(20) UNSIGNED NULL DEFAULT 0 COMMENT '排序',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `t_category`  (
  ...
  `icon` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '-1' COMMENT '类别图标',
  `type` smallint(6) NULL DEFAULT NULL COMMENT '类型 1:pc端 2:移动端',
  `category_sort` bigint(20) UNSIGNED NULL DEFAULT 0 COMMENT '排序',
  `show_status` tinyint(4) NULL DEFAULT 1 COMMENT '显示状态 0隐藏 1显示',
  ...
  `delete_status` tinyint(4) NULL DEFAULT 0 COMMENT '删除状态 0未删除 1已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 333 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品类别表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_category_area`  (
  ...
  `delete_status` tinyint(4) NULL DEFAULT 0 COMMENT '删除状态 0未删除 1已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '类别地区表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_column_banner`  (
  ...
  `banner_id` bigint(20) NOT NULL COMMENT '轮播图主键',
  `column_id` bigint(20) NOT NULL COMMENT '栏目主键',
  `position` smallint(6) NULL DEFAULT NULL COMMENT '位置 1:栏目左侧',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `create_date` datetime(6) NULL DEFAULT NULL COMMENT '创建时间',
  `update_date` datetime(6) NULL DEFAULT NULL COMMENT '修改时间',
  `create_admin_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人ID',
...
CREATE TABLE `t_column_img`  (
  ...
  `src` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图片地址',
  `type` smallint(6) NULL DEFAULT NULL COMMENT '类型 1:pc端 2:移动端',
  `img_sort` bigint(20) UNSIGNED NULL DEFAULT 0 COMMENT '排序',
  `show_status` tinyint(4) NULL DEFAULT 1 COMMENT '显示状态 0隐藏 1显示',
  `href` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '点击跳转路径',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `create_date` datetime(6) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `t_column_sku_category`  (
  ...
  `column_id` bigint(20) NOT NULL COMMENT '栏目主键',
  `position` smallint(6) NULL DEFAULT NULL COMMENT '位置 1:栏目顶部 2:栏目左侧',
  `category_sort` bigint(20) NULL DEFAULT NULL COMMENT '类别排序',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `create_date` datetime(6) NULL DEFAULT NULL COMMENT '创建时间',
  `update_date` datetime(6) NULL DEFAULT NULL COMMENT '修改时间',
  `create_admin_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人ID',
...
CREATE TABLE `t_event_process`  (
  ...
  `delete_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '删除状态 0未删除 1已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14073 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '收消息记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_event_publish`  (
  ...
  `delete_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '删除状态 0未删除 1已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13080 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '发消息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_news`  (
  ...
  `news_sort` bigint(20) UNSIGNED NULL DEFAULT 0 COMMENT '排序',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `create_date` datetime(6) NULL DEFAULT NULL COMMENT '创建时间',
  `update_date` datetime(6) NULL DEFAULT NULL COMMENT '修改时间',
  `app_code` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '所属应用',
...
CREATE TABLE `t_order`  (
  ...
  `pay_method` smallint(6) NULL DEFAULT NULL COMMENT '支付方式 1线上支付 2线下支付',
  ...
  `src_type` smallint(6) NULL DEFAULT NULL COMMENT '用户购买渠道 1:pc  2:app',
  ...
  `delete_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '删除状态 0未删除 1已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16105 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '订单信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_order_item`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17510 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '订单项信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_product_sku`  (
  ...
  `status` smallint(6) NULL DEFAULT 0 COMMENT '是否上架 0:未上架 1:已上架',
  ...
  `update_user_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品SKU表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_product_sku_stock`  (
  ...
  `stock_num` bigint(20) NULL DEFAULT 0 COMMENT '库存数量',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `app_code` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '所属应用',
  `delete_status` tinyint(4) NULL DEFAULT 0 COMMENT '删除状态 0未删除 1已删除',
  `create_date` datetime(6) NULL DEFAULT NULL COMMENT '创建时间',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品SKU库存表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sa_admin_role`  (
  ...
  `update_admin_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '管理员角色关联表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_user_detail`  (
  ...
  `type` tinyint(4) NULL DEFAULT NULL COMMENT '用户类型 0:买家 1:卖家 2:既是买家又是卖家',
  `create_date` datetime(6) NULL DEFAULT NULL COMMENT '创建时间',
  `delete_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '删除状态 0未删除 1已删除',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_user_shipping_address`  (
  ...
  `delete_status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '删除状态 0未删除 1已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1001 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户收货地址' ROW_FORMAT = DYNAMIC;
