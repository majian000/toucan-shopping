/*
 ...
 Source Schema         : black_bird_shopping_user_1

 Target Server Type    : MySQL
 Target Server Version : 80022
 File Encoding         : 65001

 Date: 23/03/2021 11:37:54
*/
...
-- ----------------------------
-- Table structure for bbs_user_0
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_0`;
CREATE TABLE `bbs_user_0`  (
...
-- ----------------------------
-- Records of bbs_user_0
-- ----------------------------

-- ----------------------------
-- Table structure for bbs_user_1
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_1`;
CREATE TABLE `bbs_user_1`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `password` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '密码',
  `enable_status` tinyint(0) NOT NULL DEFAULT 0 COMMENT '启用状态 0:禁用 1启用',
  `create_date` datetime(0) NOT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Table structure for bbs_user_detail_0
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_detail_0`;
CREATE TABLE `bbs_user_detail_0`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Records of bbs_user_detail_0
-- ----------------------------

-- ----------------------------
-- Table structure for bbs_user_detail_1
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_detail_1`;
CREATE TABLE `bbs_user_detail_1`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `nick_name` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '昵称',
  `true_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '真实姓名',
  `head_sculpture` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '头像',
...
-- ----------------------------
-- Records of bbs_user_detail_1
-- ----------------------------

-- ----------------------------
-- Table structure for bbs_user_email_0
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_email_0`;
CREATE TABLE `bbs_user_email_0`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Records of bbs_user_email_0
-- ----------------------------

-- ----------------------------
-- Table structure for bbs_user_email_1
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_email_1`;
CREATE TABLE `bbs_user_email_1`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '邮箱(可用于登录)',
  `user_main_id` bigint(0) NOT NULL COMMENT '用户主表ID',
  `create_date` datetime(0) NOT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Records of bbs_user_email_1
-- ----------------------------

-- ----------------------------
-- Table structure for bbs_user_login_record
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_login_record`;
CREATE TABLE `bbs_user_login_record`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Records of bbs_user_login_record
-- ----------------------------

-- ----------------------------
-- Table structure for bbs_user_mobile_phone_0
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_mobile_phone_0`;
CREATE TABLE `bbs_user_mobile_phone_0`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Records of bbs_user_mobile_phone_0
-- ----------------------------

-- ----------------------------
-- Table structure for bbs_user_mobile_phone_1
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_mobile_phone_1`;
CREATE TABLE `bbs_user_mobile_phone_1`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `mobile_phone` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '手机号(注册时必填)',
  `user_main_id` bigint(0) NOT NULL COMMENT '用户主表ID',
  `create_date` datetime(0) NOT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Records of bbs_user_mobile_phone_1
-- ----------------------------

-- ----------------------------
-- Table structure for bbs_user_username_0
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_username_0`;
CREATE TABLE `bbs_user_username_0`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Records of bbs_user_username_0
-- ----------------------------

-- ----------------------------
-- Table structure for bbs_user_username_1
-- ----------------------------
DROP TABLE IF EXISTS `bbs_user_username_1`;
CREATE TABLE `bbs_user_username_1`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `username` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户名',
  `user_main_id` bigint(0) NOT NULL COMMENT '用户主表ID',
  `create_date` datetime(0) NOT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Records of bbs_user_username_1
-- ----------------------------
