...
public interface FeignProductSkuStockService {
    ...
    ResultObjectVO inventoryReduction(@RequestHeader("bbs-sign-header") String signHeader,@RequestBody RequestJsonVO requestJsonVO);
    ...
    ResultObjectVO restoreCacheStock(@RequestHeader("bbs-sign-header") String signHeader,@RequestBody RequestJsonVO requestJsonVO);

    @RequestMapping(value="/query/sku/uuids",produces = "application/json;charset=UTF-8")
    ResultObjectVO queryBySkuUuidList(@RequestHeader("bbs-sign-header") String signHeader,@RequestBody RequestJsonVO requestJsonVO);

    @RequestMapping(value="/query/stock/cache/sku/uuids",produces = "application/json;charset=UTF-8")
    ResultObjectVO queryStockCacheBySkuUuidList(@RequestHeader("bbs-sign-header") String signHeader,@RequestBody RequestJsonVO requestJsonVO);

    @RequestMapping(method= RequestMethod.POST,value="/deduct/cache/stock",produces = "application/json;charset=UTF-8")
    ResultObjectVO deductCacheStock(@RequestHeader("bbs-sign-header") String signHeader,@RequestBody RequestJsonVO requestJsonVO);
