...
function GetRegionPlug(datas,divSelector) {
    $("."+divSelector).append(
        $("<div/>", {
            "class": divSelector+"-place-div place-div"
        }).append(
            $("<div/>", {}).append(
                $("<div/>", {
                    "class": "checkbtn"
                    ...
                    $("<a/>", {
                        ...
                        "text": "全选",
                        "click": function () {
                            $("."+divSelector).find(".place").find("input").prop("checked", true);
                    ...
                    $("<a/>", {
                        ...
                        "text": "清空",
                        "click": function () {
                            $("."+divSelector).find(".place").find("input").prop("checked", false);
...
//控制提示个数的显示
function ShowTipNum(divSelector) {
    var n = $("."+divSelector+"-place-div").find(".place");
...
function GetChecked(divSelector) {
    var Checked = [];//先清空数组
    var n = $("."+divSelector+"-place-div").find(".place");
    n.each(function (index, a) {
