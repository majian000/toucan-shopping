...
function intRootShopCategory() {
	...
	for (var i=0; i<shop_category_list.length; i++) {
		areaShopCategoryCont += '<li onClick="selectShopCategoryLevel1(' + i + '); " id="shop_category_'+category_list[i].id+'"><a href="javascript:void(0)">' + shop_category_list[i].name + '</a></li>';
	}
