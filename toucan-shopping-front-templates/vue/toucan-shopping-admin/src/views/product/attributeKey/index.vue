<template>
  <div class="attribute-key">
        ...
        <el-card shadow="never" class="table-card">
          ...
          >
            ...
            <el-table-column label="操作" width="220" fixed="right" align="center">
              <template #default="{ row }">
                <el-button type="primary" link size="small" v-permission="'toucan:product:attributeKey:row:valueList'" @click="openValueList(row)">属性值管理</el-button>
                <el-button type="primary" link size="small" v-permission="'toucan:product:attributeKey:row:update'" @click="handleEdit(row)">编辑</el-button>
                <el-button type="danger" link size="small" v-permission="'toucan:product:attributeKey:row:delete'" @click="handleDelete(row)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-card>
    ...
    <el-dialog v-model="valueDialogVisible" title="属性值管理" width="1000px" :close-on-click-modal="false" destroy-on-close>
      ...
      <div class="toolbar">
        <el-button type="primary" :icon="Plus" v-permission="'toucan:product:attribute:value:toolbar:save'" @click="handleValueAdd">添加</el-button>
        <el-button type="danger" :icon="Delete" v-permission="'toucan:product:attributeValue:toolbar:delete'" :disabled="selectedValues.length === 0" @click="handleValueBatchDelete">批量删除</el-button>
      </div>
      <el-table :data="valueTableData" border stripe v-loading="valueLoading" row-key="id" @selection-change="onValueSelectionChange">
        ...
        <el-table-column label="操作" width="130" fixed="right" align="center">
          <template #default="{ row }">
            <el-button type="primary" link size="small" v-permission="'toucan:product:attributeValue:row:update'" @click="handleValueEdit(row)">编辑</el-button>
            <el-button type="danger" link size="small" v-permission="'toucan:product:attributeValue:row:delete'" @click="handleValueDelete(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
