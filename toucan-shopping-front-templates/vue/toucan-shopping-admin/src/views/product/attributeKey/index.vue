<template>
  <div class="attribute-key">
        ...
        <el-card shadow="never" class="table-card">
          ...
          <el-table :data="tableData" border stripe v-loading="loading" row-key="id" @selection-change="onSelectionChange">
            ...
            <el-table-column label="操作" width="220" fixed="right" align="center">
              <template #default="{ row }">
                <el-button type="primary" link size="small" @click="openValueList(row)">属性值管理</el-button>
    ...
    <el-dialog v-model="valueDialogVisible" title="属性值管理" width="1000px" :close-on-click-modal="false" destroy-on-close>
      ...
      <div class="toolbar">
        <el-button type="primary" :icon="Plus" @click="handleValueAdd">添加</el-button>
        <el-button type="danger" :icon="Delete" :disabled="selectedValues.length === 0" @click="handleValueBatchDelete">批量删除</el-button>
      </div>
      <el-table :data="valueTableData" border stripe v-loading="valueLoading" row-key="id" @selection-change="onValueSelectionChange">
        ...
        <el-table-column label="操作" width="130" fixed="right" align="center">
          <template #default="{ row }">
            <el-button type="primary" link size="small" @click="handleValueEdit(row)">编辑</el-button>
            <el-button type="danger" link size="small" @click="handleValueDelete(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="pagination-wrap">
