      ...
      <el-table :data="tableData" border stripe v-loading="loading" row-key="id">
        ...
        <el-table-column label="操作" width="160" fixed="right" align="center">
          <template #default="{ row }">
            ...
            <el-button type="primary" link size="small" :icon="Edit" v-permission="'toucan:seller:designerImage:update'" @click="handleEdit(row)">编辑</el-button>
            <el-button type="danger" link size="small" :icon="Delete" v-permission="'toucan:seller:designerImage:delete'" @click="handleDelete(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
