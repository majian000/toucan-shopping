...
export default class HomePage {
  ...
  init(){
    ...
    // 华东仓(上海) 发货覆盖区域
    var HDDData = [
      [{ name: "上海" }, { name: "杭州", value: 120 }],
      [{ name: "上海" }, { name: "南京", value: 100 }],
      [{ name: "上海" }, { name: "苏州", value: 95 }],
      [{ name: "上海" }, { name: "合肥", value: 75 }],
      [{ name: "上海" }, { name: "济南", value: 65 }],
      [{ name: "上海" }, { name: "青岛", value: 55 }],
      [{ name: "上海" }, { name: "福州", value: 50 }],
      [{ name: "上海" }, { name: "厦门", value: 45 }],
    ];

    // 华南仓(广州) 发货覆盖区域
    var HNDData = [
      [{ name: "广州" }, { name: "深圳", value: 150 }],
      [{ name: "广州" }, { name: "东莞", value: 100 }],
      [{ name: "广州" }, { name: "南宁", value: 60 }],
      [{ name: "广州" }, { name: "海口", value: 40 }],
      [{ name: "广州" }, { name: "长沙", value: 70 }],
      [{ name: "广州" }, { name: "南昌", value: 50 }],
      [{ name: "广州" }, { name: "昆明", value: 45 }],
      [{ name: "广州" }, { name: "贵阳", value: 40 }],
    ];

    // 华中仓(武汉) 发货覆盖区域
    var HZDData = [
      [{ name: "武汉" }, { name: "郑州", value: 90 }],
      [{ name: "武汉" }, { name: "西安", value: 70 }],
      [{ name: "武汉" }, { name: "重庆", value: 65 }],
      [{ name: "武汉" }, { name: "太原", value: 40 }],
      [{ name: "武汉" }, { name: "石家庄", value: 55 }],
      [{ name: "武汉" }, { name: "沈阳", value: 35 }],
      [{ name: "武汉" }, { name: "大连", value: 25 }],
    ];

    // 华北仓(北京) 发货覆盖区域
    var HBDData = [
      [{ name: "北京" }, { name: "天津", value: 110 }],
      [{ name: "北京" }, { name: "石家庄", value: 60 }],
      [{ name: "北京" }, { name: "太原", value: 50 }],
      [{ name: "北京" }, { name: "沈阳", value: 55 }],
      [{ name: "北京" }, { name: "哈尔滨", value: 40 }],
      [{ name: "北京" }, { name: "长春", value: 35 }],
      [{ name: "北京" }, { name: "呼和浩特", value: 25 }],
    ];

    // 西南仓(成都) 发货覆盖区域
    var XNDData = [
      [{ name: "成都" }, { name: "重庆", value: 130 }],
      [{ name: "成都" }, { name: "昆明", value: 55 }],
      [{ name: "成都" }, { name: "贵阳", value: 50 }],
      [{ name: "成都" }, { name: "西安", value: 65 }],
      [{ name: "成都" }, { name: "兰州", value: 30 }],
    ...
    var color = ["#a6c84c", "#ffa022", "#46bee9", "#ff6b6b", "#c084fc"];
    var series = [];
    [
      ["华东仓", HDDData],
      ["华南仓", HNDData],
      ...
      tooltip: {
        ...
        formatter: function(params, ticket, callback) {
          if (params.seriesType == "effectScatter") {
            return "城市：" + params.data.name + "<br/>订单量：" + params.data.value[2] + " 万单";
