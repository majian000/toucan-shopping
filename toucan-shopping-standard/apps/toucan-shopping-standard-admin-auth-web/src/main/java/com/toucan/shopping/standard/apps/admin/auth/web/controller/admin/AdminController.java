...
public class AdminController extends UIController {
    ...
    public String editPage(HttpServletRequest request,@PathVariable Long id)
    {
        try {
            ...
            ResultObjectVO resultObjectVO = adminServiceProxy.findById(requestJsonVO);
    ...
    public String page(HttpServletRequest request)
    {
        ...
        //初始化工具条按钮、操作按钮
        super.initButtons(request,toucan,"/admin/listPage", functionServiceProxy);
    ...
    public ResultObjectVO save(HttpServletRequest request, @RequestBody AdminVO entity)
    {
        ...
        try {
            ...
            resultObjectVO = adminServiceProxy.save(requestJsonVO);
        }catch(Exception e)
        {
    ...
    public ResultObjectVO connectRoles(HttpServletRequest request, @RequestBody AdminRoleVO adminRoleVO)
    {
        ...
        try {
            ...
            resultObjectVO = adminRoleServiceProxy.saveRoles(requestJsonVO);
        }catch(Exception e)
        {
            resultObjectVO.setMsg("请重试");
            resultObjectVO.setCode(ResultObjectVO.FAILD);
    ...
    public ResultObjectVO updatePassword(HttpServletRequest request,@RequestBody AdminVO entity)
    {
        ...
        try {
            ...
            RequestJsonVO requestJsonVO = RequestJsonVOGenerator.generator(appCode, entity);
            resultObjectVO = adminServiceProxy.updatePassword(requestJsonVO);
        }catch(Exception e)
        {
            resultObjectVO.setMsg("请重试");
            resultObjectVO.setCode(ResultObjectVO.FAILD);
    ...
    public ResultObjectVO update(HttpServletRequest request,@RequestBody AdminVO entity)
    {
        ...
        try {
            ...
            RequestJsonVO requestJsonVO = RequestJsonVOGenerator.generator(appCode, entity);
            resultObjectVO = adminServiceProxy.update(requestJsonVO);
        }catch(Exception e)
        {
            resultObjectVO.setMsg("请重试");
            resultObjectVO.setCode(ResultObjectVO.FAILD);
    ...
    public TableVO list(HttpServletRequest request, AdminPageInfo pageInfo)
    {
        ...
        try {
            ...
            ResultObjectVO resultObjectVO = adminServiceProxy.list(requestJsonVO);
