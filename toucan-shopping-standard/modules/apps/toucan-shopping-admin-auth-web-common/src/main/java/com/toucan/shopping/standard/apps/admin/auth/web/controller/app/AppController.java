package com.toucan.shopping.standard.apps.admin.auth.web.controller.app;
...
public class AppController extends UIController {
    ...
    {
        //初始化工具条按钮、操作按钮
        super.initButtons(request,toucan,"/app/listPage", functionService);
    ...
    public String editPage(HttpServletRequest request,@PathVariable Long id)
    {
        try {
            ...
            ResultObjectVO resultObjectVO = appService.findById(SignUtil.sign(requestJsonVO),requestJsonVO);
    ...
    public ResultObjectVO save(HttpServletRequest request, @RequestBody App app)
    {
        ...
        try {
            ...
            RequestJsonVO requestJsonVO = RequestJsonVOGenerator.generator(appCode, app);
            resultObjectVO = appService.save(SignUtil.sign(requestJsonVO),requestJsonVO);
        }catch(Exception e)
        {
    ...
    public ResultObjectVO update(HttpServletRequest request,@RequestBody App app)
    {
        ...
        try {
            ...
            RequestJsonVO requestJsonVO = RequestJsonVOGenerator.generator(appCode, app);
            resultObjectVO = appService.update(SignUtil.sign(requestJsonVO),requestJsonVO);
        }catch(Exception e)
        {
            resultObjectVO.setMsg("请求失败,请重试");
            resultObjectVO.setCode(ResultObjectVO.FAILD);
    ...
    public TableVO listPage(HttpServletRequest request, AppPageInfo pageInfo)
    {
        ...
        try {
            ...
            ResultObjectVO resultObjectVO = appService.listPage(SignUtil.sign(requestJsonVO),requestJsonVO);
    ...
    public ResultObjectVO deleteById(HttpServletRequest request,  @PathVariable String id)
    {
        ...
        try {
            ...
            resultObjectVO = appService.deleteById(SignUtil.sign(requestVo),requestVo);
        }catch(Exception e)
        {
            resultObjectVO.setMsg("请求失败,请重试");
    ...
    public ResultObjectVO deleteByIds(HttpServletRequest request, @RequestBody List<AppVO> appVOs)
    {
        ...
        try {
            ...
            requestVo.setAppCode(appCode);
            requestVo.setEntityJson(entityJson);
            resultObjectVO = appService.deleteByIds(SignUtil.sign(requestVo), requestVo);
        }catch(Exception e)
        {
            resultObjectVO.setMsg("请求失败,请重试");
            resultObjectVO.setCode(TableVO.FAILD);
