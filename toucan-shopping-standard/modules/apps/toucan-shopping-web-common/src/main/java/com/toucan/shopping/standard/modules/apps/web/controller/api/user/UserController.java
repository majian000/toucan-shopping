package com.toucan.shopping.standard.modules.apps.web.controller.api.user;
...
import com.toucan.shopping.standard.modules.apps.web.controller.BaseController;
...
//            resultObjectVO = userService.findByMobilePhone(SignUtil.sign(requestJsonVO),requestJsonVO);
